...
/**
 * This handler belongs to {@link Events#NEW_WATERMARK}.
 *
 * @author Dominik Fuchss
 *
 */
public final class NewWatermarkHandler extends Handler {
   ...
   *          the controller
   */
  public NewWatermarkHandler(IModel model, IView view, IController controller) {
  ...
  public void run() {
    ...
    this.model.setWatermarkBaseImage(image);
  }
}